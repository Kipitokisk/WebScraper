...
class DatabaseManagerIT {
    ...
    void testParseRomanianDate_WithValidDate() {
        ...
        Timestamp result = databaseManager.parseRomanianDate(romanianDate);
    ...
    void testParseRomanianDate_WithBlankValue() {
        Timestamp result = databaseManager.parseRomanianDate("   ");
        assertNull(result);
    }
    ...
    void testParseRomanianDate_WithInvalidFormat() {
        ...
        Timestamp result = databaseManager.parseRomanianDate(invalidDate);
        assertNull(result);
    }
